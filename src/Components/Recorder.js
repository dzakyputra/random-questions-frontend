    ...
    return (
        <div className="h-1/3 bg-blue-500">
            ...
            <div className={"flex justify-center " + (this.state.downloadLink !== '' ? "mt-8" : "-mt-5")}>
                ...
                <button title="Start Recording" className="bg-blue-500 mx-2" onClick={this.startRecording} type="button" disabled={this.state.record ? true : false}>
                ...
                <button title="Stop Recording" className="bg-blue-500 mx-2" onClick={this.stopRecording} type="button" disabled={this.state.record ? false : true}>
                ...
                <button title="Download the Record" className="bg-blue-500 mx-2" onClick={this.downloadAudio} type="button" disabled={this.state.downloadLink === '' ? true : false}>
